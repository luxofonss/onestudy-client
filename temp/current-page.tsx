      ...
      <div className="container mx-auto px-4 py-4">
        ...
        <div className="grid grid-cols-12 gap-3 mb-3">
                      ...
                      <Badge
                        ...
                        className={
                          attemptDetail.passed
                            ? "bg-green-900/40 text-green-300 border-green-700/40 text-xs"
                            : "bg-red-900/40 text-red-300 border-red-700/40 text-xs"
                        }
                      >
          ...
          <div className="col-span-12 md:col-span-3">
            <Card className="h-full border-gray-700/30 bg-gray-800/20 backdrop-blur-sm shadow-md">
              <CardHeader className="py-2.5 px-4 border-b border-gray-700/20">
                <CardTitle className="text-xs text-gray-100 flex items-center gap-2">
              ...
              <CardContent className="p-3">
                <div className="space-y-2">
                  <Textarea
                    ...
                    className="min-h-[70px] bg-gray-800/30 border-gray-700/50 text-gray-200 placeholder:text-gray-500 text-xs"
                  />
                  <Button
                    onClick={handleSaveComment}
                    disabled={isSavingComment}
                    className="w-full bg-blue-600/80 hover:bg-blue-600 text-white text-xs py-1 h-auto"
                  >
                  ...
                  <AccordionContent className="px-3 pt-2 pb-3 bg-gray-800/10 rounded-md mt-1">
                    <div className="pt-1 space-y-3">
                      ...
                      <div className="p-2.5 rounded-lg bg-gray-800/30 border border-gray-700/30">
                        <h4 className="font-medium text-gray-300 text-xs mb-1.5">
                          Question:
                        </h4>
                          ...
                          {getQuestionType(answer.questionId) ===
                            ...
                            <div className="space-y-2">
                              <div className="p-2.5 rounded-lg bg-gray-800/30 border border-gray-700/30">
                                ...
                                <p className="text-xs text-gray-200 font-mono p-1.5 bg-gray-800/40 rounded-md">
                                  "
                                  {
                                    getQuestionById(answer.questionId)
                                      ?.pronunciationText
